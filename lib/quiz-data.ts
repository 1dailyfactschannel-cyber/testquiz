...
export const quizQuestions: QuizQuestion[] = [
  {
    id: 1,
    question: "Ваш подход к работе или важным делам?",
    answers: [
      { text: "Сделаю все идеально и вовремя", traitWeights: { deceit: 1, laziness: 0 } },
      { text: "Сделаю, но в последний момент", traitWeights: { laziness: 2 } },
      { text: "Переложу на другого", traitWeights: { laziness: 3, deceit: 2 } },
      { text: "Какая работа? Я хочу отдыхать", traitWeights: { laziness: 3, greed: 1 } },
    ],
  },
  {
    id: 2,
    question: "Вы нашли кошелек with крупной суммой денег на пустой улице. Ваши действия?",
    answers: [
      { text: "Заберу себе, это подарок судьбы", traitWeights: { greed: 3, deceit: 2 } },
      { text: "Попробую найти владельца", traitWeights: { greed: 0, deceit: 0 } },
      { text: "Оставлю на месте, не хочу проблем", traitWeights: { laziness: 1 } },
      { text: "Посмотрю, нет ли камер, и если нет — заберу", traitWeights: { deceit: 3, greed: 2 } },
    ],
  },
  {
    id: 3,
    ...
    answers: [
      { text: "Атакую прямо и громко", traitWeights: { annoyance: 3 } },
      { text: "Манипулирую за кулисами", traitWeights: { deceit: 3, greed: 1 } },
      { text: "Стараюсь стать 'скользким' и уйти от ответа", traitWeights: { slimy: 3, deceit: 1 } },
      { text: "Просто игнорирую, мне лень спорить", traitWeights: { laziness: 3 } },
    ],
  },
  {
    id: 4,
    question: "Ваше отношение к личной гигиене и порядку?",
    answers: [
      { text: "Я идеален и всегда чист", traitWeights: { ugliness: 0, slimy: 0 } },
      { text: "Порядок — это скучно", traitWeights: { ugliness: 1, laziness: 1 } },
      { text: "Люблю творческий беспорядок и легкую небрежность", traitWeights: { ugliness: 2, slimy: 1 } },
      { text: "Я живу в хаосе, и мне отлично", traitWeights: { ugliness: 3, slimy: 3, laziness: 2 } },
    ],
  },
  {
    id: 5,
    question: "Что вы сделаете, если коллега просит вас о помощи в его выходной?",
    answers: [
      { text: "Конечно помогу, я добрый", traitWeights: { greed: 0, annoyance: 0 } },
      { text: "Придумаю убедительную ложь, чтобы отказать", traitWeights: { deceit: 3, laziness: 1 } },
      { text: "Проигнорирую сообщение, сделаю вид, что не видел", traitWeights: { laziness: 2, deceit: 1 } },
      { text: "Помогу, но потом буду постоянно напоминать об этом долге", traitWeights: { annoyance: 3, greed: 2 } },
    ],
  },
  {
    id: 6,
